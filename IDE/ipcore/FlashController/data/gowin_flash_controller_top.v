// ===========Oooo==========================================Oooo================================
// =        Copyright (C) 2014-2023 ShanDong Gowin Semiconductor Technology Co.,Ltd.   
// =                                 All rights reserved.                         
// =============================================================================================
//           
//  __      __      __  
...
// 1.5    |  Emb     |  10/22/2020 |  Support APB bus interface and FLASH256KA,FLASH128K
// 1.6    |  Emb     |  10/20/2022 |  Support FLASH96KA, delete FLASH256KA and FLASH128K
// ===========Oooo==========================================Oooo================================
...
(
    ...
    //FLASH96KA
	`ifdef FLASH_SIZE_96KA
		//Register Interface
		`ifdef REG_IF
				input   wire  [31:0] 	wdata_i,//write data into flash
				input	wire  [5:0]  	wyaddr_i,//write y direction address
				input	wire  [5:0] 	wxaddr_i,//write x direction address
				input	wire	   		erase_en_i,//enable erase, 1:enable
				output	wire	   		done_flag_o,//erase completely flag
				input	wire	   		start_flag_i,//start erase flag
				input	wire 			clk_i,//input clock
...
`ifdef FLASH_SIZE_256K
    ...
    //APB Interface
    `ifdef APB_IF
        APB_Slave_Top_256K u_APB_Slave_Top_256K
        (
			.PRDATA         (PRDATA),
            .PREADY         (PREADY),
            .PCLK           (PCLK),
...
`ifdef FLASH_SIZE_96KA
	//Register Interface
	`ifdef REG_IF
		Flash_Ctroller_96KA u_Flash_Ctroller_96KA
		(
			.clk            (clk_i      ),
			.nreset         (nrst_i     ), 
			.wdata_i        (wdata_i    ),
...
`ifdef FLASH_SIZE_608K
    ...
    //APB Interface
    `ifdef APB_IF
        APB_Slave_Top_608K u_APB_Slave_Top_608K
        (
			.PRDATA         (PRDATA),
            .PREADY         (PREADY),
            .PCLK           (PCLK),
