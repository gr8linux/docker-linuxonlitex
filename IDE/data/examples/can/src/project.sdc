create_clock -name myclk -period 20 -waveform {0 10} [get_ports {sysclk}]
create_clock -name myclk2 -period 20 -waveform {0 10} [get_nets {u_can_top/u_canc_top/u_canc_0/ponrst_cclk_2_n}]
create_clock -name myclk3 -period 20 -waveform {0 10} [get_pins {uut_GW_PLL/pll_inst/CLKOUT}]
...
set_clock_groups -asynchronous -group [get_clocks {myclk3}] -group [get_clocks {myclk}]
