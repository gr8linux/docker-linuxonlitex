...
# installed.
TCL_PREFIX='/tools/apps/tcl8.6.5'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/tools/apps/tcl8.6.5'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/tools/downloads/tcl8.6.5/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/tools/apps/tcl8.6.5/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/tools/apps/tcl8.6.5/include'
...
# compiled.
TCL_SRC_DIR='/tools/downloads/tcl8.6.5'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/tools/apps/tcl8.6.5/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/tools/downloads/tcl8.6.5/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/tools/apps/tcl8.6.5/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tools/downloads/tcl8.6.5/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/tools/apps/tcl8.6.5/lib/libtclstub8.6.a'
